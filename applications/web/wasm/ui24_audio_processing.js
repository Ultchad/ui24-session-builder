/* @ts-self-types="./ui24_audio_processing.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function convert_audio_to_flac_bytes(bytes, extension) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(extension, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.convert_audio_to_flac_bytes(ptr0, len0, ptr1, len1);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ui24_audio_processing_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ui24_audio_processing_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
